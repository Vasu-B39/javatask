...
<body>
	...
	<form action="match" method="post"
		...
		<p id="mDate" />
		<div>
			Match Date : <input type="date" placeholder="date" name="date"
		...
		<br> <input type="submit" value="Submit" class="btn btn-success"
			id="button" href="matchSucess.jsp"/> </span>
	</form>
	...
	<script type="text/javascript">
		...
		function validateForm() {
			...
			var button = document.getElementById("button");
			if (name.length >= 3 && name.length < 30 && country.length >= 3 && country.length < 30 && date!=null && team1.length >= 3 && 
				...
				document.getElementById("invalid").innerHTML = "<span style='color:red'>Please enter Valid valid Information</span>";
				button.setAttribute("disabled", "");
